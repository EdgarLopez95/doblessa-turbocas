...
export const services: Service[] = [
  ...
  },
  {
    ...
    human: 'Toca revisión o cambio de aceite',
    icon: 'wrench',
    featured: false,
    problem: 'Mantenimiento periódico, cambio de aceite o una revisión antes de un viaje.',
    what: 'Revisamos el vehículo en nuestro taller de Castellón siguiendo el plan de mantenimiento.',
    next: 'Pide cita en el taller.',
    cta: 'Ver mecánica y mantenimiento',
  },
  {
    slug: 'mecanica-mantenimiento/',
    name: 'Revisión pre-ITV',
    human: 'Quiero pasar la ITV con tranquilidad',
    icon: 'clipboard',
    featured: false,
    problem: 'Dudas sobre si el vehículo superará la inspección técnica.',
    what: 'Revisamos los puntos habituales de la inspección y te explicamos lo que conviene corregir.',
    next: 'Reserva la revisión antes de tu cita de ITV.',
    cta: 'Ver revisiones pre-ITV',
  },
  {
    slug: 'mecanica-mantenimiento/',
